...
public class OSSClientUtil {
	...
	// accessKey
	private String accessKeyId = "LTAIJCZv2HHdNKTW";
	private String accessKeySecret = "Cti3pIARVWXIzOx3ttds8n8yT8ztQK";
	// 空间
	private String bucketName = "aparmentimg";
	// 文件存储目录
